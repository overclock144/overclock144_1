...
REPLICATE_API_TOKE = "r8_0nc2CTFjLQlIACbV4iHCVA8z2SdDhlK11jhSA"
OPENAI_API_KEY = "sk-proj-j6yh4e3u9Wairpb32RP6T3BlbkFJmGmkbAgjCyXlNGWysQmk"
...
def freechat_memory(memory,model_name,user_input):
    model = model_select(model_name)
    template = """Your name is inDB GenAI Bot. You are a chatbot mentor which is good at sql and willing to be helpful in engineer. You are chatting with a student who is learning sql.
